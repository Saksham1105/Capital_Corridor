        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="p-8 sm:p-12 bg-white border border-[#E0D9CD] rounded-sm shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-10 items-start hover:border-[#C5A059] transition-all">
            ...
            <div className="lg:col-span-8 space-y-4 text-slate-700 font-light text-sm leading-relaxed">
              ...
              <p>
                He began his career in the stock broking industry and rose to the position of Chief Executive Officer of a leading listed stock broking company, where he successfully led business operations, expansion initiatives, client acquisition, and strategic financial advisory engagements. His leadership experience has provided him with a deep understanding of financial markets, institutional lending, and corporate finance.
              </p>
              <p>
